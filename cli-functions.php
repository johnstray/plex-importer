...
if(isset($cliOptions)) {
  if(array_key_exists('v',$cliOptions) || array_key_exists('version',$cliOptions)) {
    if(function_exists('print_version')) {print_version();die();} else {die("No version information is available with this program");}
  }
  if(array_key_exists('h',$cliOptions) || array_key_exists('help',$cliOptions)) {
    if(function_exists('print_help')) {print_help();die();} else {die("No help information is available with this program");}
  }
} else {
